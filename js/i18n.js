...
const langDict = {
    zh: {
        ...
        publish_err_name_zh: "请输入中文名称",
        publish_err_name_en: "请输入英文名称",
        publish_err_desc_zh: "请输入中文描述（至少 20 字）",
    ...
    en: {
        ...
        modal_param_arch: "Architecture: ",
        modal_param_author: "Author: ",
        ...
        publish_label_name_zh: "Product Name (Chinese)",
        publish_label_name_en: "Product Name (English)",
        ...
        publish_label_desc_zh: "Description (Chinese)",
        publish_label_desc_en: "Description (English)",
        ...
        publish_err_name_zh: "Chinese name is required",
        publish_err_name_en: "English name is required",
        publish_err_desc_zh: "Chinese description required (min 20 chars)",
